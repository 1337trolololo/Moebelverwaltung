...
{
    public class FahrenderSessel : Moebelstueck, IFahrendeSitzgelegenheiten
    {
        public FahrenderSessel() :this(100,80,70,12.0,"hellbraun", Material.Kunststoff, true, 10.567)
        {
            Console.WriteLine("FahrenderSessel()");
        }

        public FahrenderSessel(int laenge, int breite, int hoehe, double gewicht, string farbe, Material materialart, bool gepolstert, double v) : base(laenge, breite, hoehe, gewicht, farbe, materialart)
        {
        ...
        public string Sitzen(string qualitaet)
        {
            ...
            {
                text += "Der Stuhl ist nicht extra gepolstert";
            }
